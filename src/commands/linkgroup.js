...
const { Locale, EmbedBuilder, ActionRowBuilder, ButtonStyle, MessageFlags, Colors, AttachmentBuilder, PermissionFlagsBits, ContainerBuilder, SectionBuilder, TextDisplayBuilder, MediaGalleryBuilder, SeparatorBuilder, SeparatorSpacingSize, ThumbnailBuilder } = require("discord.js");
...
const buttonAcceptTerms = linkGroupCommand.addButton('acceptterms', async ({ interaction, locale }) => {
    ...
    try {
        ...
        const successEmbed = new EmbedBuilder()
            ...
            .setDescription(locale['success.description'].replace('{groupName}', state.groupName))
            .setTimestamp();
