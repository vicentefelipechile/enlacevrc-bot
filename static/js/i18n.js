...
(function () {
  ...
  const ES = {
    ...
    "cmd.settings.opt.role": "Rol que se asigna a los usuarios verificados.",
    "cmd.settings.opt.plus": "Rol que se asigna a los usuarios verificados +18.",
    "cmd.settings.opt.nick": "Activa o desactiva el cambio automático de apodo al nombre de VRChat.",
    "cmd.settings.opt.log": "Canal donde el bot registra las acciones (invitaciones, expulsiones, etc.).",
  ...
  const EN = {
    ...
    "cmd.settings.opt.role": "Role assigned to verified users.",
    "cmd.settings.opt.plus": "Role assigned to 18+ verified users.",
    "cmd.settings.opt.nick": "Enables or disables automatically changing the nickname to the VRChat name.",
    "cmd.settings.opt.log": "Channel where the bot logs actions (invites, kicks, etc.).",
  ...
  const PT = {
    ...
    "cmd.settings.opt.role": "Cargo atribuído aos usuários verificados.",
    "cmd.settings.opt.plus": "Cargo atribuído aos usuários verificados +18.",
    "cmd.settings.opt.nick": "Ativa ou desativa a mudança automática do apelido para o nome do VRChat.",
    "cmd.settings.opt.log": "Canal onde o bot registra as ações (convites, expulsões, etc.).",
  ...
  const FR = {
    ...
    "cmd.settings.opt.role": "Rôle attribué aux utilisateurs vérifiés.",
    "cmd.settings.opt.plus": "Rôle attribué aux utilisateurs vérifiés +18.",
    "cmd.settings.opt.nick": "Active ou désactive le changement automatique du surnom vers le nom VRChat.",
    "cmd.settings.opt.log": "Salon où le bot enregistre les actions (invitations, exclusions, etc.).",
