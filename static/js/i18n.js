...
(function () {
  ...
  const ES = {
    ...
    "cmd.welcomepanel.opt.send": "Publica el panel en el canal configurado. Con <code>language</code> eliges su idioma.",
  ...
  const EN = {
    ...
    "cmd.welcomepanel.opt.send": "Publishes the panel in the configured channel. Use <code>language</code> to pick its language.",
  ...
  const PT = {
    ...
    "cmd.welcomepanel.opt.send": "Publica o painel no canal configurado. Com <code>language</code> você escolhe o idioma.",
  ...
  const FR = {
    ...
    "cmd.welcomepanel.opt.send": "Publie le panneau dans le salon configuré. Avec <code>language</code>, tu choisis sa langue.",
  ...
  const JA = {
    ...
    "cmd.welcomepanel.opt.send": "設定済みチャンネルにパネルを投稿します。<code>language</code>でパネルの言語を選べます。",
